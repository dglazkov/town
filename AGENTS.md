...
built, one short body of work at a time. What could come after the
seven projects below is four drafted constellations of proposed
projects, sheep, growth, infra, and square, sequenced as one sky in
[docs/drafts/night-sky.md](docs/drafts/night-sky.md); each is a shape and
not a decision until a project is cut from it. The first was
