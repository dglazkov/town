...
built, one short body of work at a time. Two further drafts sketch
...
the town aligned with sheep and usable without it, and
[docs/drafts/growth-constellation.md](docs/drafts/growth-constellation.md),
the seams between shops as project boundaries agents grow independently. The first was
